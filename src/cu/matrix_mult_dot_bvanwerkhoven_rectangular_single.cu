 ...
 *
 * The kernel computes D=(A*B).*C, where A, B are rectangular
 * matrices and C has the same dimensions as A*B.
 */
__global__ void matrix_mult_dot_bvanwerkhoven_rectangular_single(float *D, float *A, float *B, float *C,

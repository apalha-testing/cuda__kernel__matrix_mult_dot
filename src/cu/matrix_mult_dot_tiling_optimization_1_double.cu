/**
 * @file matrix_mult_dot_tiling_optimized_1_double.cu
 * 
 * CUDA code to calculate D = (A*B).*C (tiling algorithm avoid bank conflict and additional optimization, double precision)
 * 
 */
 ...
 */
__global__ void matrix_mult_dot_tiling_optimization_1_double( 
                      double * D, 
                      double * A, 
                      double * B,
		      double * C,

/**
 * @file matrix_mult_dot_tiling_double.cu
 * 
...
/** Main entry point.
 * Computes matrix multiplication using tiling algorithm followed by elementwise dot produtct (double precision)
 */
__global__ void matrix_mult_dot_tiling_double( 
                      double * D, 
                      const double * A, 
                      const double * B,
		      const double * C,
